...
const CallWaitingDialog = ({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
  ...
  //       const response = await fetch("https://callabro.onrender.com/call/1", {
  //         method: "POST",
  //         headers: {
  //           "Content-Type": "application/json",
  //         },
  //         // body: JSON.stringify({
  //         //   phoneNumber: "+919619383805",  // Receiver's number
  //         //   name: "Siddh Jain",  // User's name in distress
  //         // }),
  //       });
  //     }
  //     catch(error){
  ...
  const handleClick = (e: React.FormEvent) => {
    ...
    const sendDistressCall = async () => {
      try {
        ...
        const response2 = await fetch("https://callabro.onrender.com/call/1", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
        ...
        const response3 = await fetch("https://callabro.onrender.com/message/send-alert", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
        ...
        console.log("✅ Call Initiated:", data2);
        console.log("✅ Message Initiated:", data3);
        ...
        {status === 'input' && (
          <div className="space-y-4">
            <div className="text-center">
              ...
              Alert Your Loved Ones With a Simple Distress Call
        Current Numbers:
        <br />
        +919619383805
        <br />
